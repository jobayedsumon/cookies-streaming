            ...
            <div class="col-md-12">
                <section class="pageContent" style="{{ request()->get('webView') ? 'margin-top: 3rem': '' }}">
                    ...
                    <ul>
                        ...
                        <li>We may use your email or phone number to contact you, sending notifications related transactional.</li>
                    </ul>

                    <h2>PAYMENTS, REFUND AND CANCELLATION, PAYOUTS</h2>
                    <h3>Payments:</h3>
                    <p>You are required to pay only using your ‘Google Play Store Balance’.</p>
                    <h3>Refund and Cancellation:</h3>
                    <p>We allow refund/cancellation of orders as per user request but user have to ask for refund within 24  hours of Order placed with us.</p>
                    <h3>Payouts:</h3>
                    <p>We currently provide payouts through PayPal and Tether (USD₮ – Binance.com) for users. Payouts may take upto 7 – 14 working days to reach to your account.</p>

                    <h2>CHARGES:</h2>
                    <p>Please note that Google will charge 30% of your total amount as their ‘transaction fee’.</p>
                    <p>Apart from this we charge 0% – 10% (according to your Packages) of your total amount as our service fee.</p>
                    <p>So at last, you will receive 50% – 60% (according your Package) of the total amount after all deductions. This charge will directly deduct at the time of your payouts.</p>
